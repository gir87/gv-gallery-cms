      ...
      <div>
        ...
        >
          ...
          <input 
            ...
            disabled={status === UploadStatus.ANALYZING || status === UploadStatus.COMPRESSING}
          />
        </div>
        
        {status === UploadStatus.ANALYZING && (
          <div className="mt-4 flex items-center gap-3 text-indigo-600 bg-indigo-50 p-3 rounded-lg text-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea 
            ...
            placeholder="Description generated by AI..."
          />
        </div>
